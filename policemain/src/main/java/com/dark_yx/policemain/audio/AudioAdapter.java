...
public class AudioAdapter extends BaseAdapter {
    ...
    public AudioAdapter(Context context, List<DataDicBean.ResultBean.ItemsBean> tags) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.audio_tag_item, null);
        ...
        holder.radioButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AudioAdapter.this.position = position;
            }
        });
