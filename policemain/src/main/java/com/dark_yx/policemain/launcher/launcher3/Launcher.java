...
import com.dark_yx.policemain.launcher.launcher3.allapps.AllAppsContainerView;
import com.dark_yx.policemain.launcher.launcher3.compat.AppWidgetManagerCompat;
import com.dark_yx.policemain.launcher.launcher3.compat.LauncherActivityInfoCompat;
import com.dark_yx.policemain.launcher.launcher3.compat.LauncherAppsCompat;
import com.dark_yx.policemain.launcher.launcher3.compat.UserHandleCompat;
import com.dark_yx.policemain.launcher.launcher3.compat.UserManagerCompat;
import com.dark_yx.policemain.launcher.launcher3.model.WidgetsModel;
import com.dark_yx.policemain.launcher.launcher3.util.ComponentKey;
import com.dark_yx.policemain.launcher.launcher3.util.LongArrayMap;
import com.dark_yx.policemain.launcher.launcher3.util.Thunk;
import com.dark_yx.policemain.launcher.launcher3.widget.PendingAddWidgetInfo;
import com.dark_yx.policemain.launcher.launcher3.widget.WidgetHostViewLoader;
import com.dark_yx.policemain.launcher.launcher3.widget.WidgetsContainerView;
...
public class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PhoneInterfaceUtil.setActiveAdmin(mAdminName);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            startForegroundService(new Intent(this, BaseSationService.class));
        }
        LogUtil.d("Launcher运行顺序——>" + "onCreate");
    ...
    public static final String ENTER = "com.dark_yx.policemain.qd.enter";

    public void openApp(Intent intent) {
        String getNfcMessage = nfcHandle.readMessage(intent);
        LogUtil.d("onNewIntentLauncher: " + getNfcMessage);
        if (getNfcMessage != null && getNfcMessage.length() > 0) {
            LogUtil.d("message--->>" + getNfcMessage);
            if (getNfcMessage.contains(ENTER)) {
    ...
    protected void onNewIntent(Intent intent) {
        LogUtil.d("Launcher运行顺序——>" + "onNewIntent");
        openApp(intent);
        String getNfcMessage = nfcHandle.readMessage(intent);
    ...
    public void onSettingsChanged(String settings, boolean value) {
        LogUtil.d("Launcher运行顺序——>" + "onSettingsChanged");
    ...
    public void onPostCreate(Bundle savedInstanceState) {
        LogUtil.d("Launcher运行顺序——>" + "onPostCreate");
    ...
    public boolean setLauncherCallbacks(LauncherCallbacks callbacks) {
        LogUtil.d("Launcher运行顺序——>" + "setLauncherCallbacks");
    ...
    public void onLauncherProviderChange() {
        LogUtil.d("Launcher运行顺序——>" + "onLauncherProviderChange");
        if (mLauncherCallbacks != null) {
    ...
    private void handleActivityResult(
        ...
        LogUtil.d("Launcher运行顺序——>" + "handleActivityResult");
    ...
    protected void onActivityResult(
            final int requestCode, final int resultCode, final Intent data) {
        LogUtil.d("Launcher运行顺序——>" + "onActivityResult");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
                                           int[] grantResults) {
        LogUtil.d("Launcher运行顺序——>" + "onRequestPermissionsResult");
    ...
    protected void onStart() {
        super.onStart();
//        PhoneInterfaceUtil.setMenuStatus(mAdminName, false);
        LogUtil.d("Launcher运行顺序——>" + "onStart");
    ...
    private void initChat() {
        if (!TextUtils.isEmpty(DataUtil.getToken())) {
            if (chatService == null) {
    ...
    protected void onResume() {
        LogUtil.d("Launcher运行顺序——>" + "onResume<--->" + DataUtil.isEnter(this));
        LogUtil.d("chatService is not running");
        if (DataUtil.isEnter(this)) {
            ...
            startActivity(myIntent);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                startForegroundService(new Intent(this, ListenCallService.class));
            }
//            startActivity(new Intent(this, MainActivity.class));
        } else {
            stopService(new Intent(this, ListenCallService.class));
            LogUtil.d("launcherResume--->" + "生活模式");
            initChat();
        }
...
//         Restore the previous launcher state
    ...
    protected void onPause() {
        ...
        super.onPause();
        if (nfcAdapter != null) {
            nfcAdapter.disableForegroundDispatch(this);//鍏抽棴鍓嶅彴鍙戝竷绯荤粺
        }
        mPaused = true;
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        LogUtil.d("Launcher运行顺序——>" + "onWindowFocusChanged");
        mHasFocus = hasFocus;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        LogUtil.d("Launcher运行顺序——>" + "onKeyDown");
    ...
    private void restoreState(Bundle savedState) {
        ...
        if (pendingAddContainer != ItemInfo.NO_ID && pendingAddScreen > -1) {
            ...
            mPendingAddWidgetInfo = info == null ?
                    null : LauncherAppWidgetProviderInfo.fromProviderInfo(
                    this, info);
    ...
    public void onAttachedToWindow() {
        ...
        LogUtil.d("Launcher运行顺序——>" + "onAttachedToWindow");
    ...
    public void onDetachedFromWindow() {
        ...
        LogUtil.d("Launcher运行顺序——>" + "onDetachedFromWindow");
        mVisible = false;
    ...
    public void onRestoreInstanceState(Bundle state) {
        ...
        LogUtil.d("Launcher运行顺序——>" + "onRestoreInstanceState");
    ...
    protected void onSaveInstanceState(Bundle outState) {
        if (mWorkspace.getChildCount() > 0) {
            LogUtil.d("Launcher运行顺序——>" + "onSaveInstanceState");
    ...
    public void onDestroy() {
        super.onDestroy();
        LogUtil.d("Launcher运行顺序——>" + "onDestroy");
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
        ...
        LogUtil.d("Launcher运行顺序——>" + "startActivityForResult");
    ...
    public void startIntentSenderForResult(IntentSender intent, int requestCode,
        ...
        LogUtil.d("Launcher运行顺序——>" + "startIntentSenderForResult");
        onStartForResult(requestCode);
        try {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        LogUtil.d("Launcher运行顺序——>" + "onPrepareOptionsMenu");
    ...
    public boolean onSearchRequested() {
        LogUtil.d("Launcher运行顺序——>" + "onSearchRequested");
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        LogUtil.d("Launcher运行顺序——>" + "dispatchKeyEvent");
    ...
    public void onBackPressed() {
        LogUtil.d("Launcher运行顺序——>" + "onBackPressed");
    ...
    public void onAppWidgetHostReset() {
        LogUtil.d("Launcher运行顺序——>" + "onAppWidgetHostReset");
    ...
    void startAppShortcutOrInfoActivity(View v) {
        LogUtil.d("Launcher运行顺序——>" + "startAppShortcutOrInfoActivity");
        Object tag = v.getTag();
        final ShortcutInfo shortcut;
        Intent intent = null;
        if (tag instanceof ShortcutInfo) {
            shortcut = (ShortcutInfo) tag;
            Log.d(TAG, "ShortcutInfo: " + shortcut.getTargetComponent().getPackageName());
    ...
    boolean startApplicationUninstallActivity(ComponentName componentName, int flags,
        ...
        if ((flags & AppInfo.DOWNLOADED_FLAG) == 0) {
            ...
            LogUtil.d("ACTION_DELETE>>>" + packageName);
            if (user != null) {
    ...
    private boolean startActivity(View v, Intent intent, Object tag) {
        LogUtil.d("Launcher运行顺序——>" + "startActivity");
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        try {
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        LogUtil.d("Launcher运行顺序——>" + "dispatchPopulateAccessibilityEvent");
    ...
    public void bindScreens(ArrayList<Long> orderedScreenIds) {
        LogUtil.d("Launcher运行顺序——>" + "bindScreens");
    ...
    public void bindAddScreens(ArrayList<Long> orderedScreenIds) {
        LogUtil.d("Launcher运行顺序——>" + "bindAddScreens");
    ...
    public void bindWidgetsRestored(final ArrayList<LauncherAppWidgetInfo> widgets) {
        LogUtil.d("Launcher运行顺序——>" + "bindWidgetsRestored");
        Runnable r = new Runnable() {
            public void run() {
    ...
    public void bindShortcutsChanged(final ArrayList<ShortcutInfo> updated,
        ...
        LogUtil.d("Launcher运行顺序——>" + "bindShortcutsChanged");
        Runnable r = new Runnable() {
            public void run() {
    ...
    public void bindRestoreItemsChange(final HashSet<ItemInfo> updates) {
        LogUtil.d("Launcher运行顺序——>" + "bindRestoreItemsChange");
        Runnable r = new Runnable() {
            public void run() {
    ...
    public void bindComponentsRemoved(final ArrayList<String> packageNames,
        ...
        LogUtil.d("Launcher运行顺序——>" + "bindComponentsRemoved");
        Runnable r = new Runnable() {
            public void run() {
    ...
    public void bindAllPackages(final WidgetsModel model) {
        LogUtil.d("Launcher运行顺序——>" + "bindAllPackages");
