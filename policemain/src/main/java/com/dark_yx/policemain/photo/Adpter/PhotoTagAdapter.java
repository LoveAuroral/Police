package com.dark_yx.policemain.photo.Adpter;
...
public class PhotoTagAdapter extends BaseAdapter {
    ...
    public PhotoTagAdapter(Context context, List<DataDicBean.ResultBean.ItemsBean> tags) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.photo_tag_item, null);
        ...
        holder.radioButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PhotoTagAdapter.this.position = position;
            }
        });
